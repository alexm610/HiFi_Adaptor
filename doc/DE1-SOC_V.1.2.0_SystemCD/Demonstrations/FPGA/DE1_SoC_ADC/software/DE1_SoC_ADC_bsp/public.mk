...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../DE1_SoC_ADC.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x50
SOPC_SYSID_FLAG += --sidp=0x50
ELF_PATCH_FLAG  += --sidp 0x50

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1383718665
SOPC_SYSID_FLAG += --timestamp=1383718665
ELF_PATCH_FLAG  += --timestamp 1383718665
